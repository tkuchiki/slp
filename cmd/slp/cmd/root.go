...
func NewRootCmd(version string) *cobra.Command {
	...
	rootCmd.PersistentFlags().BoolP("bundle-where-in", "", false, "Bundle WHERE IN conditions")
	rootCmd.PersistentFlags().BoolP("bundle-values", "", false, "Bundle VALUES of INSERT statement")
